...
const createThemes = function <Theme> (
...
const { ThemeProvider, useTheme } = createThemes < Record<any, unknown>>(
  '__vue_jsx_jss_provide_key__',
  defaultTheme
)

export { ThemeProvider, useTheme, createThemes }
