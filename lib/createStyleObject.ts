...
import { useTheme as useDefaultTheme, Theming } from './theme-defaults'
...
export type DefaultTheme = Record<symbol, unknown>
...
function createStyleObject<Theme = DefaultTheme, C extends string = string> (
  styles: Styles<Theme, Record<symbol, unknown>, C>,
